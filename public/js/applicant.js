...
function getEnrollDiv(id){
	...
	var cloneRow = "<p>Which kind of insurance? </p></br><table class=''><tr class = 'coverage'><td><input type='checkbox' name='otherInsuranceStateCHIPProgram' id='otherInsuranceStateCHIPProgram' value='1'/> Childrens Health Insurance Program (CHIP)</td></tr>	<tr class = 'coverage'><td><input type='checkbox' name='otherInsurancePrivate' id='otherInsurancePrivate' value='1'/> Individual health plan (not from a job)</td><td><input type='checkbox' name='otherInsuranceVA' id='otherInsuranceVA' value='1'/>Veterans Affair's Health Care</td></tr><tr class = 'coverage'><td><input type='checkbox' name='otherInsuranceMedicare' id='otherInsuranceMedicare' value='1'/> Medicare</td><td><input type='checkbox' name='otherInsuranceTricare' id=otherInsuranceTricare' value='1'/>TriCare</td></tr><tr class = 'coverage'><td><input type='checkbox' name='otherInsuranceStateMedicaidProgram' id='otherInsuranceStateMedicaidProgram' value='1'/> Medicaid</td></tr></table>";
...
// }	
 var id	= numItems + 2;
var tmp = '<div class="formbox countformbox" id="formbox'+id+'"><input type="hidden" name="applicant_type_id" id="applicant_type_id_'+id+'"  value = "'+numItems+'" />	<div class="info-container"><table class="applyingForCoverage" id="applyingForCoverage-'+id+'"><tr id="form2_first-'+id+'" class = "form2_first"><td><span class="table-headers">Applying for Coverage?</span><select name="applyingCoveragehealth" id="applyingCoveragehealth-'+id+'" onchange="hidefieldsOnNo(this.id)" ><option value="">Select...</option>		<option value="1" selected >Yes</option><option value="0">No</option></select></td></tr></table><table class="contactBasicInfo" id="contactBasicInfo"><tbody><tr  id="form2_first-'+id+'" class = "form2_first"><td><span class="table-headers">First Name</span><br/><input type="text" name="addApplicantFirstName" id="addApplicantFirstName-'+id+'" /></td><td><span class="table-headers">Last Name</span><br/><input type="text" name="addApplicantLastName" id="addApplicantLastName-'+id+'" /></td><td><span class="table-headers">Suffix</span><br/><select name="addApplicantSuffix" id = "addApplicantSuffix-'+id+'">';
